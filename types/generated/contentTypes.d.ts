...
export interface ApiBlockedBusinessPartnerBlockedBusinessPartner
  extends Schema.CollectionType {
  collectionName: 'blocked_business_partners';
  info: {
    singularName: 'blocked-business-partner';
    pluralName: 'blocked-business-partners';
    displayName: 'Blocked Business Partner';
    description: '';
  };
  options: {
    draftAndPublish: false;
  ...
  attributes: {
    BusinessPartnerID: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::blocked-business-partner.blocked-business-partner',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiNightlyNotificationTemplateNightlyNotificationTemplate
  ...
  info: {
    singularName: 'nightly-notification-template';
    pluralName: 'nightly-notification-templates';
    displayName: 'Nightly Notification Template';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::nightly-notification-template.nightly-notification-template',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
